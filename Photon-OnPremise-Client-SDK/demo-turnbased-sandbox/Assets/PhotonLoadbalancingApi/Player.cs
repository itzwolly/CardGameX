...
namespace ExitGames.Client.Photon.LoadBalancing
{
    ...
    public class Player
    {
        ...
        public void SetCustomProperties(Hashtable propertiesToSet, Hashtable expectedValues = null, WebFlags webFlags = null)
        {
            ...
            Hashtable customProps = propertiesToSet.StripToStringKeys().Clone() as Hashtable;
            Hashtable customPropsToCheck = expectedValues.StripToStringKeys().Clone() as Hashtable;
            ...
            {
                this.RoomReference.LoadBalancingClient.loadBalancingPeer.OpSetPropertiesOfActor(this.actorID, (Hashtable) customProps.Clone(), customPropsToCheck.Clone(), webFlags);
            }
        }
