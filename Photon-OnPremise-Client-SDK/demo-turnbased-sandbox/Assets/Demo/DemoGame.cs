...
public class DemoGame : LoadBalancingClient
{
    ...
    protected internal override Player CreatePlayer(string actorName, int actorNumber, bool isLocal, System.Collections.Hashtable actorProperties)
    {
        ExitGames.Client.Photon.Hashtable table = (ExitGames.Client.Photon.Hashtable) actorProperties.Clone();

        return new DemoPlayer(actorName, actorNumber, isLocal, table);
    }
    ...
    public void SaveBoardAsProperty()
    {
        ...
        this.OpSetCustomPropertiesOfRoom((System.Collections.Hashtable) boardProps.Clone());
    ...
    public void UpdateBoard()
    {
        ...
        Hashtable roomProps = (Hashtable) this.CurrentRoom.CustomProperties.Clone();
