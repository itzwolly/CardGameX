...
namespace Photon.Hive
{
    ...
    public class GameState 
    {
        ...
        public SerializablePlayer[] Players { get; set; }
        public SerializablePlayer ActivePlayer { get; set; }
        public SerializablePlayer Opponent { get; set; }
        ...
        public bool SetState(SerializableGameState state)
        {
            ...
            this.Players = state.Players ?? new SerializablePlayer[2];
            return true;
        }
